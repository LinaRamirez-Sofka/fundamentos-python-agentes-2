...
def validate_pass(password: str, logged_user: str)-> str:
    """
    Valida una contraseña verificando que tenga al menos 8 caracteres
    (excluyendo espacios al principio y final) y que no sea igual al nombre de usuario.
...
def handle_calculator_operations(first_number: str, operator: str,
                                  second_number: str) -> str:
    """
    Gestiona operaciones básicas de calculadora (+, -, *, /) en dos números proporcionados
    como cadenas, imprime el resultado y valida la entrada y la división por cero.
    """
...
chat_history: MemoriaAgente  = [
    {'timestamp': '21-03-2026 21:06:16', 'cmd': 'ping', 'author': 'admin','rol': 'admin', 'description': 'Se envió un ping y se devuelve un pong'}
]    
